...
export default function GridCanvas({ numDays, columnWidth, events, selectedEvent, onEventBlockPress, onEventsLayerEmptyPress,
  onEventsLayerLongPress }: GridCanvasProps) {
    return (<View
        style={{
          position: "relative",
