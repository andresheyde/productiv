...
export function createPlanningTurnInstructions(): string {
  return [
    ...
    "If the user has given a concrete outcome plus at least one goal-supporting activity or focus area, enough information exists for a useful first draft; stop asking questions and set status to plan_ready.",
